...
### step 1
anx_atv_step1 <- lm(pasTot_cov ~ 1 + pasTot_T1 + pfcTot_cov + negAffect_T1, data = nona_mcd_anx)
...
### step 1
dep_atv_step1 <- lm(pfcTot_cov ~ 1 + pfcTot_T1 + pasTot_cov + negAffect_T1, data = nona_mcd_dep)
